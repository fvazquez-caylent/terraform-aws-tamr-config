...
curl https://s3.us-east-2.amazonaws.com/amazoncloudwatch-agent-us-east-2/$osv/$arch/latest/amazon-cloudwatch-agent.$extension --output agent.$extension
...
echo " {
    \"logs\": {
            \"endpoint_override\": \"vpce-08a69900c8a14e667-bh80ggli.logs.us-east-2.vpce.amazonaws.com\",
      \"logs_collected\": {
             \"files\": {
                 \"collect_list\": [
                     {
                         \"file_path\": \"/emr/instance-controller/log/bootstrap-actions/**.log\",
                         \"log_group_name\": \"poc-cw-sec-config-com-tamr_log_group\",
